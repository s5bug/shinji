...
trait ClosedMonoidal[Obj, Hom[_ <: Obj, _ <: Obj], I <: Obj, Tens[_ <: Obj, _ <: Obj] <: Obj, Exp[_ <: Obj, _ <: Obj] <: Obj] extends Closed[Obj, Hom, I, Exp] with StrongProfunctor[Obj, Hom, I, Tens, Exp] with Monoidal[Obj, Hom, I, Tens] {
